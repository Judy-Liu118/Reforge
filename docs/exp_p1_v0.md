...
|---|---|---|---|---|---|---|---|
| `P1` | cold.A | `P1_seed_orders_profit` | RECOVERED | 2 | 1.00 | 2 | 54.76 |
| `P1` | cold.A' | `P1_transfer_customers_margin` | RECOVERED | 2 | 1.00 | 2 | 71.74 |
| `P1` | warm.A | `P1_seed_orders_profit` | RECOVERED | 2 | 1.00 | 2 | 84.42 |
| `P1` | warm.A' | `P1_transfer_customers_margin` | RECOVERED | 2 | 1.00 | 2 | 51.78 |